...
export const INITIAL_HEALTH_METRICS: HealthMetrics = {
  ...
  dailyTimeline: [
    ...
    },
    {
      id: 'tl_3',
      time: '09:30 AM',
      title: 'Guided Courtyard Stroll',
      category: 'Walk',
      description: 'Completed 1,800 steps in courtyard with Nurse Anjali. Mood: Calm & cheerful.',
      isCompleted: true,
    },
    {
      id: 'tl_4',
    ...
    },
    {
      ...
      category: 'Hydration',
      description: 'Drank 400ml chamomile herbal tea with vegetable soup. Total: 1650ml.',
      isCompleted: true,
    },
    {
      id: 'tl_6',
      time: '04:30 PM',
      title: 'Evening Cognitive Recall & Audio Puzzles',
      category: 'CognitiveGame',
      description: 'Scheduled: 15-minute voice prompt puzzle session.',
      isCompleted: false,
    },
    {
      id: 'tl_7',
...
export const INITIAL_REMINDERS: ReminderItem[] = [
  {
    ...
    category: 'Medicine',
    time: '08:00 AM',
    dosageOrDetail: '1 tablet after breakfast (Cognitive memory support)',
...
export const INITIAL_COGNITIVE_PROGRESS: CognitiveProgress = {
  overallScore: 86,
